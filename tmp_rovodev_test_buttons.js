...
async function testButtonMessages() {
    ...
    try {
        ...
        const result = await generateWAMessageContent({ buttons: buttonMessage }, mockOptions);
    ...
    try {
        ...
        const result = await generateWAMessageContent({ templateButtons: templateMessage }, mockOptions);
